...
public class King extends Piece{
    public King(int col, int row, int color) throws IOException {
        super(col, row, color);

        type = Type.KING;

        if (color == GamePanel.WHITE) {
            image = ImageIO.read(getClass().getResourceAsStream("/res/piece/w-king.png"));
        }else {
            image = ImageIO.read(getClass().getResourceAsStream("/res/piece/b-king.png"));
        }
    }
