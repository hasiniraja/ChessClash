...
public class GamePanel extends JPanel implements Runnable{
    ...
    boolean gameOver;
    boolean stalemate;
    private int winnerColor = -1; // -1 means no winner yet
...
//        testIllegal();
                ...
                if (activeP != null){
                    ...
                    if (validSquare){
                        ...
                        if (isKingInCheck() && isCheckMate()) {
                            gameOver = true;
                            winnerColor = (currentColor == WHITE) ? BLACK : WHITE;

                        }
                        else if (isStalemate() && !isKingInCheck()){
                            stalemate = true;
                            JOptionPane.showMessageDialog(this, "Game Over – It's a Draw (Stalemate)", "Draw", JOptionPane.INFORMATION_MESSAGE);
                        }
    ...
    private void promotion() throws IOException {
    ...
    public void paintComponent(Graphics g){
        ...
        if (gameOver){
            ...
            String s = (winnerColor == WHITE) ? "White Wins" : "Black Wins";
    ...
    private  boolean canPromote() throws IOException {
